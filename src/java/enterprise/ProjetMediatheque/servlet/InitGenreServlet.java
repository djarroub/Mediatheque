 ...
 * @author Gilles
 */
@WebServlet(name = "InitGenreServlet", urlPatterns = {"/InitGenre"})
public class InitGenreServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String[] tabGenre = {"Horreur",
                ...
                "Article"};
            for (int i = 0; i<11; i++) {
                em.persist(new Genre(tabGenre[i]));
            }
            //em.persist(new Genre("eée"));
            utx.commit();
        } catch (Exception ex) {
